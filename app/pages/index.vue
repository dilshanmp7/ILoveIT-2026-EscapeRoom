...
<template>
  <main class="access-page">
    ...
    <aside class="access-aside" aria-label="Dispatch floor preview">
      <div class="aside-topline"><span>CPH HUB</span><span>LIVE</span></div>
...
.access-grid {
  ...
  inset: 0;
  opacity: .18;
  background-image: linear-gradient(90deg, transparent 49%, #f5f0df 50%, transparent 51%), linear-gradient(#f5f0df 1px, transparent 1px);
...
.input-row {
  display: flex;
  gap: .7rem;
  border-bottom: 1px solid #5b5c54;
  padding-bottom: .7rem;
}
...
.floor-graphic {
  ...
  background: linear-gradient(135deg, transparent 49.8%, #4c504d 50%, transparent 50.2%), linear-gradient(45deg, transparent 49.8%, #4c504d 50%, transparent 50.2%);
  background-size: 8rem 8rem;
}
