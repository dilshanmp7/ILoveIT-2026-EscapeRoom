...
export const SECTOR_OBJECTIVES: Record<1 | 2 | 3, SectorObjective[]> = {
  1: [
    { id: "term_l1_1", label: "AURA Gen-AI Fundamentals Console", shortLabel: "Gen-AI", questionId: "ai-1", position: { x: -14.0, z: -3.8 } },
    { id: "term_l1_2", label: "AURA Logistics Optimization Terminal", shortLabel: "Logistics", questionId: "ai-2", position: { x: -11.0, z: -3.8 } },
    { id: "term_l1_3", label: "AURA Data Leak Protection Hub", shortLabel: "Data Leak", questionId: "ai-4", position: { x: -8.0, z: -3.8 } },
    { id: "term_l1_4", label: "AURA Predictive Sorting Station", shortLabel: "Sorting", questionId: "ai-5", position: { x: -14.0, z: -1.5 } },
    { id: "term_l1_5", label: "AURA Hallucination Detection Unit", shortLabel: "Hallucinate", questionId: "ai-7", position: { x: -8.0, z: -1.5 } },
  ...
  2: [
    { id: "term_l2_1", label: "CPH Apps: GUS Butterfly Blue Terminal", shortLabel: "GUS Blue", questionId: "app-1", position: { x: -3.0, z: -3.8 } },
    { id: "term_l2_2", label: "CPH Apps: Sherloc Logistics Hub", shortLabel: "Sherloc", questionId: "app-2", position: { x: -1.0, z: -3.8 } },
    { id: "term_l2_3", label: "CPH Apps: App Incident Response Desk", shortLabel: "App Team", questionId: "app-3", position: { x: 1.0, z: -3.8 } },
    { id: "term_l2_4", label: "CPH Apps: ServiceNow Incident Console", shortLabel: "ServiceNow", questionId: "app-4", position: { x: 3.0, z: -3.8 } },
    { id: "term_l2_5", label: "CPH Apps: Power Automate & UAT Hub", shortLabel: "Power Auto", questionId: "app-5", position: { x: 3.0, z: -1.5 } },
  ...
  3: [
    { id: "term_l3_1", label: "Cyber Vault: Phishing Detection Sentinel", shortLabel: "Phishing", questionId: "sec-1", position: { x: 7.5, z: -3.8 } },
    { id: "term_l3_2", label: "Cyber Vault: Email Domain Authenticator", shortLabel: "Domains", questionId: "sec-2", position: { x: 10.0, z: -3.8 } },
    { id: "term_l3_3", label: "Cyber Vault: Password Cryptography Console", shortLabel: "Passwords", questionId: "sec-3", position: { x: 12.5, z: -3.8 } },
    { id: "term_l3_4", label: "Cyber Vault: Data Classification Sentinel", shortLabel: "Data Class", questionId: "sec-4", position: { x: 10.5, z: -1.5 } },
    { id: "term_l3_5", label: "Cyber Vault: Zscaler & Remote Access Pod", shortLabel: "Zscaler", questionId: "sec-5", position: { x: 7.5, z: -1.5 } },
    { id: "key_sector_3", label: "Master Override Cryptokey", shortLabel: "Master Key", position: { x: 12.0, z: 2.0 } },
